...
export default function(internals) {
  ...
  Utilities.setPropertyUnchecked(
    ...
    function(namespace, name, newValue) {
      ...
      const oldValue = Native.Element_getAttributeNS.call(
        this,
        namespace,
        name
      );
  ...
  Utilities.setPropertyUnchecked(
    ...
    function(namespace, name) {
      ...
      const newValue = Native.Element_getAttributeNS.call(
        this,
        namespace,
        name
      );
  ...
  function patch_insertAdjacentElement(destination, baseMethod) {
    Utilities.setPropertyUnchecked(
      ...
      function(position, element) {
        ...
        const insertedElement /** @type {!Element} */ = baseMethod.call(
          this,
          position,
          element
        );
    ...
    Utilities.setPropertyUnchecked(
      ...
      function(position, text) {
        ...
        if (position === 'beforebegin') {
          ...
          upgradeNodesInRange(
            /** @type {!Node} */ (marker || this.parentNode.firstChild),
            this
          );
