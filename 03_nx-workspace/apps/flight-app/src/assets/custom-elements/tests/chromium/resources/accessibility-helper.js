function buildAccessibilityTree(
  ...
  str +=
    allAttributesRequired && accessibilityObject.role == ''
      ? accessibilityObject.allAttributes()
      : '';
  str +=
    targetObject && accessibilityObject.isEqual(targetObject)
      ? '     ' + targetString
      : '';
  str += '\n';
  ...
  if (accessibilityObject.name.indexOf('End of test') >= 0) return false;
