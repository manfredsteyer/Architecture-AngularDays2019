...
suite('Custom Element Reactions', function() {
  ...
  suite('constructor', function() {
    ...
    test('new E() works with ES5-style classes', function() {
      ...
      Object.defineProperty(XES5.prototype, 'constructor', {
        value: XES5,
        configurable: true,
        writable: true
      });
    ...
    test('ES5 constructor is called when instantiated via createElement', function() {
      ...
      Object.defineProperty(XBarES5.prototype, 'constructor', {
        value: XBarES5,
        configurable: true,
        writable: true
      });
  ...
  suite('attributeChangedCallback', function() {
    ...
    test('called for existing observed attributes', function() {
      ...
      assert.equal(
        changed.length,
        1,
        'should only trigger for observed attributes'
      );
  ...
  suite('moving and reconnecting', function() {
    ...
    test('entered left apply to view', function() {
      ...
      assert.deepEqual(
        invocations,
        ['constructor'],
        'created but not entered view'
      );

      // // note, cannot use instanceof due to IE
      assert.equal(
        element.__proto__,
        XEnteredLeft.prototype,
