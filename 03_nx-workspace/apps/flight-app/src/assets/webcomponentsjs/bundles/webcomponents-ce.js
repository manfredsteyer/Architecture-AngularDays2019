...
(function() {
      ...
      if (c.nodeType === Node.ELEMENT_NODE) {
        ...
        if ('link' === f && 'import' === e.getAttribute('rel')) {
          ...
          if (c instanceof Node && !d.has(c))
            for (d.add(c), c = c.firstChild; c; c = c.nextSibling) q(c, a, d);
          c = p(b, e);
          continue;
        } else if ('template' === f) {
          c = p(b, e);
  ...
  C.prototype.f = function(b) {
    ...
    for (a = 0; a < b.length; a++)
      for (var d = b[a].addedNodes, c = 0; c < d.length; c++) B(this.c, d[c]);
  };
  function ca() {
    var b = this;
    ...
    function d(a, b) {
      ...
      t(a, 'insertAdjacentHTML', function(a, c) {
        ...
        if ('beforebegin' === a) {
          ...
          (e = this.firstChild), b.call(this, a, c), d(this.firstChild, e);
        else if ('beforeend' === a)
          (e = this.lastChild),
            b.call(this, a, c),
